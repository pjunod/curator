...
**Started:** 2026-09-19 · **Current baseline:** `9e39362`
...
- [x] Rebased onto `9e39362` after PR #31 advanced `main`; shared generated
  artifacts and affected tests were revalidated.
...
- [x] Usage/architecture documentation and version `0.27.0` update. The
  original `0.25.3` bump was advanced after rebasing over `main`'s `0.26.0`.
- [x] Acceptance fixtures cover scope membership, grouping, pack rejection,
  ...
  validation races. The final test lane is recorded below.
...
4. **The final review happened once.** An adversarial agent inspected the
...
After `main` advanced through PR #31, the branch was rebased onto `9e39362`.
Code generation was clean; `go build ./...`, web typecheck, the affected Go
packages, all 88 current web tests, production build, and the Wanted E2E all
passed again on the rebased tree.
