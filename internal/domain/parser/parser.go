...
var sourcePatterns = []struct {
	...
	{regexp.MustCompile(`(?i)\bM4A\b`), quality.SourceM4A},
	{regexp.MustCompile(`(?i)\bMP3\b`), quality.SourceMP3},
	{regexp.MustCompile(`(?i)\bAAC\b`), quality.SourceAAC},
	{regexp.MustCompile(`(?i)\bFLAC\b`), quality.SourceFLAC},
	{regexp.MustCompile(`(?i)\bOGG\b`), quality.SourceOGG},
	{regexp.MustCompile(`(?i)\bOPUS\b`), quality.SourceOPUS},
	{regexp.MustCompile(`(?i)\bWAV\b`), quality.SourceWAV},
	{regexp.MustCompile(`(?i)\bWMA\b`), quality.SourceWMA},
