...
## Native mobile apps ✅ (built 2026-08-01, v0.18.1)
...
- [x] First-run setup automatically discovers and displays IPv4/IPv6 servers
      through DNS-SD on Wi-Fi, pairs by QR, or normalizes manual URLs
