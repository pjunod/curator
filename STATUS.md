...
## Native mobile apps ✅ (built 2026-08-01, v0.18.0)

- [x] One Expo/React Native project produces iOS and Android bundles
- [x] First-run setup discovers IPv4/IPv6 servers through DNS-SD on Wi-Fi,
      pairs by QR, or normalizes manual LAN/VPN/reverse-proxy URLs
