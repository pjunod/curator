...
export const getMetadataPreview = (query: string) => get<MetadataPreview>(`/metadata/preview?${query}`)
...
export const putRecoverySettings = (body: RecoverySettings) => send('PUT', '/import/recovery/settings', body)
export const getRecoveries = () => get<RunnerRecovery[]>('/import/recovery')
export const previewRecovery = (body: RecoveryRequest) => send<RecoveryPreviewTask>('POST', '/import/recovery/preview', body)
